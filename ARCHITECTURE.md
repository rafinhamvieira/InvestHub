...
- **Configuração em banco guarda só a diferença.**  tem linha apenas para o que foi alterado; sem linha, vale o  ou o padrão de código, e apagar a linha desfaz a mudança. O registro em  é a fonte única de rótulo, unidade e **limites** — campo livre num painel é pé de cabra, e cada faixa tem o porquê escrito. Segredos e conexões continuam só no ; parâmetros de outros containers não estão na tela, porque a aplicação não os lê.

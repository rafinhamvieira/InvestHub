...
> **Status**: em produção. Produto completo (dashboard, carteira, aporte, alocação, proventos, renda fixa, screeners, valuation, watchlist, importação/exportação). Painel administrativo em construção por etapas — Etapas 1 a 5 entregues: auditoria imutável com RBAC e sessões, números da plataforma e saúde, gestão de contas, backup com ensaio de restauração e logs da aplicação.
